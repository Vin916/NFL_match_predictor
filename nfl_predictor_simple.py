#!/usr/bin/env python3
"""
NFL Match Predictor using Ensemble Machine Learning Models (Simplified Version)
Combines Logistic Regression, Decision Trees, and Random Forest
...
class NFLPredictor:
    ...
    def train_models(self, X_train, y_train):
        """Train ensemble models (without XGBoost)"""
    ...
    def predict_games(self, upcoming_games=None):
        ...
        if upcoming_games is None:
            ...
            try:
                ...
                ].head(6)  # Take first 6 upcoming games
                
                if len(upcoming_schedule) == 0:
                    print("No upcoming games found, creating sample matchups from recent games...")
